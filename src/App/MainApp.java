...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Searcher searcher = new Searcher(index_path, query_path);
